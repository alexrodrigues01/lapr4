...
public class AppSettings {
    ...
    private static final String NUMBER_THREADS="threads.numero";
    private static final String GRAMATICA="gramatica";
    ...
    private void setDefaultProperties() {
        ...
        this.applicationProperties.setProperty(ALGORITMO,"FCFS");
        this.applicationProperties.setProperty(NUMBER_THREADS,"3");
        this.applicationProperties.setProperty(GRAMATICA,"visitor");
    }
    ...
    public Boolean isFCFS(){
        return "FCFS".equalsIgnoreCase(this.applicationProperties.getProperty(ALGORITMO));
    }

    public Boolean isCarga(){
        return "AlgoritmoCarga".equalsIgnoreCase(this.applicationProperties.getProperty(ALGORITMO));
    }

    public Boolean isVisitor(){
        return "visitor".equalsIgnoreCase(this.applicationProperties.getProperty(GRAMATICA));
    }

    public Integer numberOfThreads(){
        return Integer.parseInt(this.applicationProperties.getProperty(NUMBER_THREADS));
    }
