...
public class FormularioVisitorImplement extends FormularioGrammarBaseVisitor<Integer> {
    ...
    @Override
    public Integer visitLinha(FormularioGrammarParser.LinhaContext ctx) {
    ...
    private void flagExpressaoRegularDelay(String nome, String resposta){
        if (nome.equalsIgnoreCase("Codigo Produto") && ( resposta.startsWith("20") || resposta.startsWith("21") ) ) {
            ...
            indexExp = 1;
            expressaoRegularAlterada = "[0-9]+[.,]([1-9][0-9]+|[0]+[1-9][0-9]+)";
        }
    }
    ...
    @Override
    public Integer visitMudarObrigatoriedade(FormularioGrammarParser.MudarObrigatoriedadeContext ctx) {
        ...
        return super.visitMudarObrigatoriedade(ctx);
    }
