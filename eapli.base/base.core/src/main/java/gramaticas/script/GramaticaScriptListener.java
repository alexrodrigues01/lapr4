...
public interface GramaticaScriptListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code atribuirOp}
	 * labeled alternative in {@link GramaticaScriptParser#opcoes}.
	 * @param ctx the parse tree
	 */
	void enterAtribuirOp(GramaticaScriptParser.AtribuirOpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code atribuirOp}
	 * labeled alternative in {@link GramaticaScriptParser#opcoes}.
	 * @param ctx the parse tree
	 */
	void exitAtribuirOp(GramaticaScriptParser.AtribuirOpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GramaticaScriptParser#atribuir}.
	 * @param ctx the parse tree
	 */
	void enterAtribuir(GramaticaScriptParser.AtribuirContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaScriptParser#atribuir}.
	 * @param ctx the parse tree
	 */
	void exitAtribuir(GramaticaScriptParser.AtribuirContext ctx);
	/**
	 * Enter a parse tree produced by {@link GramaticaScriptParser#atribuirOpcoes}.
	 * @param ctx the parse tree
	 */
	void enterAtribuirOpcoes(GramaticaScriptParser.AtribuirOpcoesContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaScriptParser#atribuirOpcoes}.
	 * @param ctx the parse tree
	 */
	void exitAtribuirOpcoes(GramaticaScriptParser.AtribuirOpcoesContext ctx);
}